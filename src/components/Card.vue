  ...
  const globalActionUnsubscribe = globalStore.$onAction(
    ({ name, args }) => {
      if (name === 'updateRemoteCurrentConnection' || name === 'removeRemoteCurrentConnection') {
        ...
        addCompletedUpload(args[0]).then(() => {
          updateUrls()
          updateMediaUrls()
        })
...
const addCompletedUpload = async (upload) => {
  ...
  if (urlType !== 'link') {
    update.linkToSpaceId = null
    update.linkToCardId = null
    update.linkToSpaceCollaboratorKey = null
    update.urlPreviewUrl = null
    update.urlPreviewImage = null
    update.urlPreviewFavicon = null
    update.urlPreviewTitle = null
    update.urlPreviewDescription = null
    update.urlPreviewErrorUrl = null
    update.urlPreviewEmbedHtml = null
    update.urlPreviewIframeUrl = null
  }
...
const previewIsVisible = computed(() => {
  if (cardHasMedia.value) { return false }
