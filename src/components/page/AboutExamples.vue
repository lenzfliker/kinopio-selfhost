...
const isSelfHosted = computed(() => consts.isSelfHosted())
...
section.examples(ref="parentElement")
  ...
  .examples-wrap
    ...
    .example.whiteboard(v-show="state.example === 'whiteboard'")
      ...
      p(v-if="!isSelfHosted") Invite friends and group members to collaborate together in real-time.
      p(v-else) Share read-only links when you want to publish a space from your own server.
    ...
    .example.moodboard(v-show="state.example === 'moodboard'")
      ...
      p(v-if="!isSelfHosted") You can also import your Are.na channels.
      p(v-else) Drag images, videos, and files directly into your space to keep source material local.

    .example.research(v-show="state.example === 'research'")
      img(src="@/assets/page/about/examples/research.webp" alt="research space")
    ...
    .example.websites(v-show="state.example === 'websites'")
      img(src="@/assets/page/about/examples/websites.webp" alt="website space")
      ...
      p(v-else) Public spaces can be shared directly from your own instance without a global explore feed.
