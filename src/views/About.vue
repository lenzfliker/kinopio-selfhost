    ...
    main.page(@click="closeAllDialogs")
      .page-wrap
        section.intro
          ...
          p(v-if="isSelfHosted") Self-hosted Kinopio with a single admin account, local uploads, and SQLite storage.
          p(v-else) Free for 100 cards. No sign up required.

          //- cta
          .button-wrap
            router-link(to="/app")
              button.success {{ isSelfHosted ? 'Open App' : 'Open Kinopio' }}
